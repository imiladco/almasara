...
function header_full_final() {
        ob_start();
?>
<header class="flex flex-row justify-between items-center gap-16">
    <div class="flex flex-row gap-16">
        <a href="/" class="logo">
            <img src="/wp-content/uploads/2025/06/logo.svg" alt="almasaraalamat" class="w-full" style="height:48px">
        </a>
        <nav class="nav-menu" aria-label="Main Navigation">
            <ul class="flex flex-row items-center gap-8 font-normal text-body-1 m-unset height-full">
                ...
                <li style="height: 40px;"><a class="px-4 rounded-md height-full flex items-center"
                        href="/offers/" style="color: #4B5259;">فروش ویژه</a></li>
                <li class="a-divider" style="background:#0000001f;width:1px;height:24px;"></li>
                <li style="height: 40px;"><a class="px-4 rounded-md height-full flex items-center"
                        href="/verify/" style="color: #4B5259;">شرایط خرید</a></li>
            </ul>
        </nav>
    </div>
...
add_shortcode('header_full_final', 'header_full_final');